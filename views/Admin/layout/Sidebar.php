...
<body>
  ...
  <aside
    id="siderbaradmin"
    class="sticky top-0 flex flex-col z-[100] bg-white border-r border-slate-200 shadow-lg top-0 transition-all duration-200 ease-in-out absolute top-0 bottom-0 h-full min-w-[300px]
    ...
    ">
      ...
      <a href="?act=admintour" class="clickloadAdminPage relative group flex items-center gap-3 px-3 py-2 rounded-md text-slate-700 hover:bg-indigo-50 transition">
