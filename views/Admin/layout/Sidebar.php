...
<body>
  ...
  <aside class="flex flex-col z-[10] bg-white border-r border-slate-200 shadow-lg sticky top-0 h-screen transition-all duration-200 ease-in-out
    ...
    ">
      <!-- Nav item -->
      <a href="?act=home"
        class="clickloadAdminPage flex items-center gap-3 px-3 py-2 rounded-md  text-hover bg-indigo-50">
        <i class="fa-solid fa-house"></i>
        <span>Bảng điều khiển</span>
      </a>

      <a href="?act=categoriestour"
        class="clickloadAdminPage flex items-center gap-3 px-3 py-2 rounded-md text-slate-700 hover:bg-indigo-50">
        <i class="fa-solid fa-list"></i>
        <span>Quản Lý Danh Mục Tour</span>
      </a>

      <a href="?act=admintour"
        class="clickloadAdminPage flex items-center gap-3 px-3 py-2 rounded-md text-slate-700 hover:bg-indigo-50">
      ...
      <details class="group relative">
        ...
        <div class="detailsitems mt-1 ml-8 flex flex-col gap-1 group-open:w-auto w-0">
          <a href="?act=supplier-list"
            class="clickloadAdminPage px-3 py-2 rounded-md text-slate-600 hover:bg-indigo-50">Nhà cung cấp</a>
          <a href="?act=supplier-list-types"
            class="clickloadAdminPage px-3 py-2 rounded-md text-slate-600 hover:bg-indigo-50">Loại dịch vụ</a>
        </div>
      </details>
      ...
      <details class="group">
        ...
        <div class="detailsitems mt-1 ml-8 flex flex-col gap-1 group-open:w-auto w-0">
          <a href="?act=listclient"
            class="clickloadAdminPage px-3 py-2 rounded-md text-slate-600 hover:bg-indigo-50">khách Hàng</a>
          <a href="?act=liststaff"
            class="clickloadAdminPage px-3 py-2 rounded-md text-slate-600 hover:bg-indigo-50">Nhân viên</a>
        </div>
      </details>
      ...
      <a href="?act=revenues"
        class="clickloadAdminPage flex items-center gap-3 px-3 py-2 rounded-md text-slate-700 hover:bg-indigo-50">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-slate-400 flex-shrink-0" fill="none"
    ...
    <div class="max-w-xs mx-auto xl:block md:hidden">
      <div class="relative min-h-[300px] bg-white rounded-2xl shadow-lg p-6 pt-10"
        style="background: linear-gradient(180deg, rgba(238,246,255,0.8), rgba(255,255,255,0.95));">
        <!-- top icon -->
        <div class="absolute -top-6 left-1/2 transform -translate-x-1/2 ">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-20 h-20 text-main" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
              d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.955a1 1 0 00.95.69h4.162c.969 0 1.371 1.24.588 1.81l-3.37 2.45a1 1 0 00-.364 1.118l1.286 3.955c.3.921-.755 1.688-1.54 1.118l-3.37-2.45a1 1 0 00-1.176 0l-3.37 2.45c-.784.57-1.84-.197-1.54-1.118l1.286-3.955a1 1 0 00-.364-1.118L2.063 9.382c-.783-.57-.38-1.81.588-1.81h4.162a1 1 0 00.95-.69l1.286-3.955z" />
          </svg>
        </div>
        ...
        <div class="absolute inset-x-4 bottom-4 h-20 rounded-lg"
          style="background: linear-gradient(180deg, transparent, rgba(99,102,241,0.06)); filter: blur(12px); opacity: 0.9;">
        </div>
      </div>
    </div>
  </aside>
