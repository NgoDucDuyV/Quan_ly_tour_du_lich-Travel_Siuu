            ...
            <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-20">
                    ...
                    <div class="flex items-center space-x-8">
                        <button id='toggleButtonId' onclick="toggleSidebar('siderbaradmin')" class="bg-[#0000] text-dark text-[20px] font-[100] flex items-center justify-center hover:text-hover scale-[1.2] active:scale-[1] transition-all duration-200 ease-out ">
