...
<body class="bg-gray-100 flex items-center justify-center h-[100vh]">
    <section
        class="sm:w-auto w-full sm:h-auto h-full max-w-5xl shadow-2xl rounded-xl overflow-hidden bg-white flex flex-col md:flex-row">
        <!-- Left panel -->
        <div
        ...
        <div
            ...
            <form id="formlogin" action="<?= BASE_URL ?>?mode=client&act=login" method="POST" class="space-y-6 w-full">
                ...
                <div>
                    ...
                    <input type="text" id="login_email" name="username" required
                ...
                <div>
                    <button type="submit"
                        ...
                        data-page="auth" data-action="login">
                        LOG IN
                    </button>
                </div>
