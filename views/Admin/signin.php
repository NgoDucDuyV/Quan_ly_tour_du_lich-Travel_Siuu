    ...
    <section class="sm:w-auto w-full sm:h-auto h-full max-w-5xl shadow-2xl rounded-xl overflow-hidden bg-white flex flex-col md:flex-row">
        ...
        <div class="md:flex-2 w-full sm:max-w-[550px] sm:min-h-[600px] h-full m-auto p-6 sm:p-12 flex flex-col items-center justify-center ">
            ...
            <div class="w-full mb-6">
                <div class="flex flex-row item-center bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative flex items-start space-x-3" role="alert">
                    <i class='bx bx-error-circle text-2xl flex-shrink-0'></i>
                    <div class="flex flex-row item-center">
                        <strong class="font-bold">Lỗi!:</strong>
                        <span class="block sm:inline">khôgn thành công </span>
                    </div>
                </div>
            </div>

            <form action="#" method="post" class="w-full *:mb-5
            [&_input]:h-[70px] [&_button]:h-[70px]">
