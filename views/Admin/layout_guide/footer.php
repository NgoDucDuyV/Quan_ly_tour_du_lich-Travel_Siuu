<footer class="bg-[#0f2b57] text-gray-200 z-10 ">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-center sm:text-left">
                    ...
                    <li><a href="#" class="text-gray-300 hover:text-[#5288e0] transition duration-300">Tour Nước ngoài</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-center sm:text-left">
                    ...
                    <li><a href="#" class="text-gray-300 hover:text-[#5288e0] transition duration-300">Câu hỏi Thường gặp (FAQ)</a></li>
                </ul>
            </div>
