...
<aside id="sidebar"
    ...
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-lg font-bold text-slate-800">HDV Panel</h2>
    ...
    <nav class="space-y-2 flex-1 overflow-y-auto">
        ...
        <a href="?mode=admin&act=scheduleguide"
            class="flex items-center gap-3 px-3 py-2 rounded-md text-sm text-slate-700 hover:bg-slate-50">
            <i class="fa-solid fa-"></i>Lịch trình & Tour</a>
        <a href="?mode=admin&act=listguide"
            class="flex items-center gap-3 px-3 py-2 rounded-md text-sm text-slate-700 hover:bg-slate-50"><i
                data-lucide="users"></i>Danh sách khách</a>
        <a href="?mode=admin&act=diaryguide"
            class="flex items-center gap-3 px-3 py-2 rounded-md text-sm text-slate-700 hover:bg-slate-50"><i
                data-lucide="book-open"></i>Nhật ký tour</a>
        <a href="?mode=admin&act=checkguide"
            class="flex items-center gap-3 px-3 py-2 rounded-md text-sm text-slate-700 hover:bg-slate-50"><i
                data-lucide="check-square"></i>Check-in & Điểm danh</a>
        <a href="?mode=admin&act=requestguide"
            class="flex items-center gap-3 px-3 py-2 rounded-md text-sm text-slate-700 hover:bg-slate-50"><i
                data-lucide="alert-circle"></i>Yêu cầu đặc biệt</a>
    </nav>
