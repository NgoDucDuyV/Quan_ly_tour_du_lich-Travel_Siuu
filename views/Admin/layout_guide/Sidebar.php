<aside id="sidebarHDV" class="flex flex-col z-[10] bg-white border-r border-slate-200 shadow-lg top-0 transition-all duration-200 ease-in-out absolute top-0 bottom-0 h-full min-w-[300px]
    ...
    ">
        ...
        <!-- Nav items -->
        <a href="?mode=admin&act=homeguide"
            class="clickloadHDVPage relative group flex items-center gap-3 px-3 py-2 rounded-md text-slate-700 hover:bg-indigo-50 transition">
            <i class="fa-solid fa-house"></i>
            <span>Trang chủ</span>
            <p
                class="absolute left-[120%] top-1/2 -translate-y-1/2 w-48 bg-white text-black rounded-md shadow-lg p-2 text-sm
        ...
        <a href="?mode=admin&act=listguide"
            class="clickloadHDVPage relative group flex items-center gap-3 px-3 py-2 rounded-md text-slate-700 hover:bg-indigo-50 transition">
            <i data-lucide="users"></i>
            <span>Danh sách khách</span>
        </a>

        <a href="?mode=admin&act=diaryguide"
            class="clickloadHDVPage relative group flex items-center gap-3 px-3 py-2 rounded-md text-slate-700 hover:bg-indigo-50 transition">
        ...
        <a href="?mode=admin&act=requestguide"
            class="clickloadHDVPage relative group flex items-center gap-3 px-3 py-2 rounded-md text-slate-700 hover:bg-indigo-50 transition">
