        ...
        <table class="min-w-full divide-y divide-slate-100">
            <thead class="bg-slate-50 text-slate-500 text-sm font-medium">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left text-xs font-medium text-slate-500 uppercase">Tổng tour</th>
            ...
            <tbody class="divide-y divide-slate-100 text-sm text-slate-700">
                <?php if (empty($dataSupplier)): ?>
                    <tr>
                        <td colspan="11" class="px-4 py-3 text-center text-xs font-medium text-slate-500 uppercase">
                ...
                <?php else: ?>
                    <?php foreach ($dataSupplier as $value): ?>
                        <tr class="hover:bg-slate-50 transition">
                            ...
                            <td class="px-6 py-4 text-center"><?= $value['total_tours'] ?? 0 ?></td>
                            <td class="px-6 py-4 text-left text-slate-500"><?= $value['supplier_updated_at'] ?? '' ?></td>
