...
echo match ($act) {
    ...
    // chức năng thanh siderbar admin quản lý điều hành tour
    'home' => (function () {
            requireAdmin();
    ...
    'supplier-create' => (function () {
            requireAdmin();
            (new AdminSupplierController)->storeSupplier();
            exit;
        })(),

    'editsupplier' => (function () {
            requireAdmin();
            (new AdminSupplierController)->editSupplier();
        })(),
    ...
    'supplier-type-create' => (function () {
            requireAdmin();
            (new AdminSupplierController)->storeSupplierType();
            exit;
        })(),

    'edit-supplier-type' => (function () {
            requireAdmin();
            (new AdminSupplierController)->editSupplierType();
        })(),
